...
crawled_at: 2025-11-13T17:19:02.237028
title: https://mitsuba.readthedocs.io/
---

Contents Menu Expand Light mode Dark mode Auto light/dark, in light mode Auto light/dark, in dark mode
Hide navigation sidebar
Hide table of contents sidebar
[Skip to content](https://mitsuba.readthedocs.io/en/stable/#furo-main-content)
Toggle site navigation sidebar
[Mitsuba 3](https://mitsuba.readthedocs.io/en/stable/)
Toggle Light / Dark / Auto color theme
Toggle table of contents sidebar
[ Back to top ](https://mitsuba.readthedocs.io/en/stable/)
Toggle Light / Dark / Auto color theme
Toggle table of contents sidebar
...
# Getting started[¶](https://mitsuba.readthedocs.io/en/stable/#getting-started "Link to this heading")
...
## Installation[¶](https://mitsuba.readthedocs.io/en/stable/#installation "Link to this heading")
...
### Requirements[¶](https://mitsuba.readthedocs.io/en/stable/#requirements "Link to this heading")
  * `Python >= 3.8`
  * (optional) For computation on the GPU: `NVidia driver >= 535`
  * (optional) For vectorized / parallel computation on the CPU: `LLVM >= 11.1`


## Hello World![¶](https://mitsuba.readthedocs.io/en/stable/#hello-world "Link to this heading")
...
```
Copy to clipboard
[**Build and run** apps in over 115 regions with MongoDB Atlas, the database for every enterprise.](https://server.ethicalads.io/proxy/click/9506/019a7c82-c917-7c90-9ed7-d8aff1dcf2c5/)
