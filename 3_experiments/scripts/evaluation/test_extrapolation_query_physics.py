...
def main():
    parser = argparse.ArgumentParser(description="Physics-only extrapolation query test")
    parser.add_argument("--data-root", default=None)
    parser.add_argument("--manifest", default=None)
    parser.add_argument("--checkpoint", default="archive/Week3-4_MLP_Hybrid_Failed/checkpoints/stage1_best.pt")
    parser.add_argument("--output", default="experiments/week4_extrapolation_query")
    ...
    gt_sh = load_ground_truth_sh_extrapolation(test_configs, data_dir, probe_idx=args.probe_idx)
